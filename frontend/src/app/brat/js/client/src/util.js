...
//             return color;
    ...
    var loadFonts = function(webFontURLs, dispatcher) {
      ...
      webFontURLs = webFontURLs || [
        'assets/js/static/fonts/Astloch-Bold.ttf',
        'assets/js/static/fonts/PT_Sans-Caption-Web-Regular.ttf',
        'assets/js/static/fonts/Liberation_Sans-Regular.ttf'
      ];
      ...
      setTimeout(function() {
        if (!fontsLoaded) {
          console.error('Timeout in loading fonts Darryl');
          proceedWithFonts();
        }
      }, fontLoadTimeout);
    };
